...
error_fg = '{{red}}'
fg_1 = '{{foreground}}'
bg_1 = '{{dark_background}}'
fg_2 = '{{foreground}}'
bg_2 = '{{lighter_background}}'
fg_3 = '{{background}}'
bg_3 = '{{blue}}'
fg_4 = '{{background}}'
bg_4 = '{{green}}'
...
[character]
success_symbol = "[](fg:success_fg bg:bg_6)" #✅
error_symbol = "[✘](fg:error_fg bg:bg_6)" #⛔
format = "[$symbol ](bg:bg_6)"

[status]
disabled = false
format = '[$status:$common_meaning ](fg:error_fg bg:bg_6)'
...
[time]
disabled = true
time_format = "%I:%M%p" # Hour:Minute Format # %T for seconds
style = "bg:bg_1"
