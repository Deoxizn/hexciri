...
version = 1
name = "Hexciri"
description = "Follow your Hexciri system theme."
variant = "dark"
inherits = "vicinae-dark"
icon = "$HOME/.local/share/hexciri/icon.png"
...
cp -p -f "$output_file" "$HOME/.local/share/vicinae/themes/hexciri.toml"

vicinae theme set hexciri
