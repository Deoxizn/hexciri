...
#
#   curl --fail --retry 3 --location --output hexciri https://hexciri.dirty.pizza/install
#   sh hexciri
...
BOOTSTRAP_REV=8   # bump on every bootstrap.sh change; printed first so reports are unambiguous
CHANNEL="stable"
